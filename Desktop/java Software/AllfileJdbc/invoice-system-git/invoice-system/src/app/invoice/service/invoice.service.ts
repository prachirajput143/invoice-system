...
export class InvoiceService {
  ...
  constructor(
    ...
    private urlService: InvoiceUrlService,
    private clientUrl: ClientUrlService,
    private companyUrl: CompanyUrlService
  ) {}
  ...
  getInvoicesByClientId(clientId: number): Observable<any[]> {
    return this.http.get<any[]>(`${this.BASE_URL}/invoices/findByClientId/${clientId}`);
  }

  getInvoiceByNumber(invoiceNumber: string): Observable<any> {
    const url = `${this.BASE_URL}/invoices/findByInvoiceNumber/${invoiceNumber}`;
